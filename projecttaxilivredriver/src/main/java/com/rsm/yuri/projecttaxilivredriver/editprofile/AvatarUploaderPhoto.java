...
public class AvatarUploaderPhoto implements UploaderPhoto {

    private EventBus eventBus;
    private FirebaseAPI firebase;

    public AvatarUploaderPhoto(EventBus eventBus, FirebaseAPI firebase) {
    ...
    public void uploadPhoto(Uri selectedImageUri) {
        if(selectedImageUri!=null) {
            Log.d("d", "AvatarUploaderPhoto.post(url, ProfileEventUPLOAD_INIT)");
            ...
            firebase.updateAvatarPhoto(selectedImageUri, new FirebaseStorageFinishedListener() {
                ...
                public void onSuccess(String url) {
                    Log.d("d", "AvatarUploaderPhoto.post(url, ProfileEventUPLOAD_COMPLETE)");
                    post(url, EditProfileEvent.UPLOAD_PHOTO_DRIVER_COMPLETE);
                }
